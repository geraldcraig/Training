...
const app = new Realm.App({ id: "application-0-pncju", timeout: 10000 });
...
getRealm = async () => {
  ...
  const configuration = {
    ...
    sync: {
      ...
      partitionValue: "65554a73927c01024596f784", // should be userId(Unique) so it can manage particular user related documents in DB by userId
    }
  };
